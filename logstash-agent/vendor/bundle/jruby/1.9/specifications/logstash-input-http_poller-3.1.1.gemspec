# -*- encoding: utf-8 -*-
# stub: logstash-input-http_poller 3.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-http_client>, ["< 5.0.0", ">= 2.2.4"])
      ...
      s.add_dependency(%q<logstash-mixin-http_client>, ["< 5.0.0", ">= 2.2.4"])
